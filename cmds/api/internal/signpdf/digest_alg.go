...
// bestDigestAlgForPdfVer returns the most secure digest/hash algorithm supported in the specified PDF version (ver).
...
func bestDigestAlgForPdfVer(ver string) (crypto.Hash, error) {
	switch ver {
	case "1.0", "1.1", "1.2":
		return 0, fmt.Errorf("PDF version %s does not support digital signatures", ver)
	case "1.3", "1.4", "1.5":
